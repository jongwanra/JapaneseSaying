...
//									ct.outMsg.println(gson.toJson(
//											new Parking(0, "", "", "", "", 0, null, null, "주차성공", 0, "registration")));
//								}
//							}
//						} else {
...
//								if (ct.pk.getCnum().equals(pk.getCnum())) {
//									ct.outMsg.println(gson.toJson(
//											new Parking(0, "", "", "", "", 0, null, null, "주차실패", 0, "registration")));
//								}
//							}
//						}
...
//						for (ParkingThread ct : parkingThreads) {
//							ct.outMsg.println(
//									gson.toJson(new Parking(0, "", "", "", "", 0, stat, fee, "", 0, "refresh")));
//						}
...
//										ct.outMsg.println(gson.toJson(new Parking(num, pk.getCnum(), "", "", "", price,
//												null, fee, "주차시간", 0, "Parking_Minute")));
//									}
//								}
//							}
//						}
...
//								ct.outMsg.println(gson.toJson(new Parking(datas.getNum(), datas.getCnum(),
//										datas.getPnum(), datas.getEntime(), datas.getExtime(), datas.getPrice(), null,
//										null, "데이터", datas.getPos(), "Information")));
//							}
//						}
...
//								ct.outMsg.println(gson.toJson(new Parking(0, "", "", "", "", 0, null, null,
//										Integer.toString(sum), 0, "PriceSum")));
//							}
//						}
//					}
//					// 그밖의 경우 즉 일반 메시지인 경우
...
//		SayingServer server = new SayingServer();
//		server.start();
//	}
//}
